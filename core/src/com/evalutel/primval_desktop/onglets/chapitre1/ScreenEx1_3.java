    ...
    private class MoveMainToReserve extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            if (cptBille < billesList.size())
            {
                ...
                uneSouris.moveTo(durationMillis, posXmain, posYmain, nextEtape, 1000);
...
//            bille.setActive(false);
    ...
    private class EtapeDragBille extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            ...
            uneSouris.cliqueTo(durationMillis, posX, posY, null, 2000);
    ...
    private class ClickMainTo1Calculette extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            ...
            uneSouris.cliqueTo(1_000, posX, posY, nextEtape, 1000);
    ...
    private class MoveMainTo1Validate extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            ...
            uneSouris.moveTo(durationMillis, posX, posY, nextEtape, 1000);
        }
    }
    ...
    private class ClickOnValidate extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            ...
            uneSouris.cliqueTo(durationMillis, posX, posY, nextEtape, 1000);
    ...
    private class ClickMainTo3Calculette extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            ...
            uneSouris.cliqueTo(durationMillis, posX, posY, nextEtape, 1500);
    ...
    private class ClickMainTo5Calculette extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            ...
            uneSouris.cliqueTo(durationMillis, (int) posX, (int) posY, nextEtape, 1000);
    ...
    private class MoveMainTo6Calculette extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            ...
            uneSouris.moveTo(durationMillis, (int) posX, (int) posY, nextEtape, 1000);
        }
    }
    ...
    private class ClickMainTo9Calculette extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            ...
            uneSouris.cliqueTo(durationMillis, (int) posX, (int) posY, nextEtape, 1500);
    ...
    private class MoveMainTo9Validate extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            ...
            uneSouris.moveTo(durationMillis, (int) posX, (int) posY, nextEtape, 1500);
        }
    }
    ...
    private class EtapeAddBille extends MyTimer.TaskEtape
    {
        ...
        public void run()
        {
            ...
            uneSouris.moveTo(50, posX, posY, null, 1000);
