...
public class UneBilleAnimation3 extends AnimationImage
{
    ...
    public UneBilleAnimation3(ArrayList<String> imagesPaths, final float startPositionX, final float startPositionY, float animationHeight, float animationWidth)
    {
