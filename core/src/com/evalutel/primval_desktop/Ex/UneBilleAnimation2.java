...
public class UneBilleAnimation2 extends AnimationImage
{
    ...
    public UneBilleAnimation2(ArrayList<String> imagesPaths, final float startPositionX, final float startPositionY, float animationHeight, float animationWidth)
    {
